...
class FirebaseAuthService: AuthService {
    ...
    override fun signInUserWithEmailAndPassword(email: String, pword: String, callback: OnServiceDataCallback<String>) {


        firebaseAuth.signInWithEmailAndPassword(email, pword).addOnCompleteListener { task ->
